# pygame demo 3 - одно изображение, непрерывный режим,
# перемещать, пока зажата клавиша.
...
while True:
    ...
    if key_pressed_tuple[K_RIGHT]:
        ball_x = ball_x + N_PIXELS_TO_MOVE
    if key_pressed_tuple[K_UP]:
        ball_y = ball_y - N_PIXELS_TO_MOVE
    if key_pressed_tuple[K_DOWN]:
        ball_y = ball_y + N_PIXELS_TO_MOVE
